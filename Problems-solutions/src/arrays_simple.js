...
// sort մեթոդը վերադարձնում է 1, եթե 1-ին անունը պետք է դրվի 2-րդից հետո, և -1, եթե 2-րդից առաջ, և 0, եթե էլեմենտների դասավորությունը չպետք է փոխել:
...
// function userSortedFirstName(users) {
//   return users.sort((a, b) => (a.name.first > b.name.first) ? 1: (a.name.first == b.name.first) ? 0: -1); 
// }

// console.log(userSortedFirstName(userSorted));

// *********************************************************

// ! 2. Calculate the total salary of all users and log the overall amount. (customersSalary)

// function allCustomersSalarySum(users) {
//   return users.reduce((sum, el) => sum + parseFloat(el.salary), 0);
// };
...
//   },
// ];
// console.log(allCustomersSalarySum(customersSalary));

// *********************************************************

//! 3. Create a new array that filters out all users whose friend count is less than 8. (filterUser)

// function filterUserFrends(users) {
//   return users.filter((user) => (user.friends.length < 8))
// };
...
//   },
// ];
// console.log(filterUserFrends(filterUser));
